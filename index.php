...
<section class="section section--white">
  <div class="wrap">
    <div class="section-head" data-reveal>
      <span class="eyebrow eyebrow--center">Our practice, in pictures</span>
      <h2 class="headline">A closer look at <em>who we are</em>.</h2>
      <p class="lead">Office, events, client moments and behind-the-scenes glimpses of the boutique practice. Photos will replace these placeholders as Kuresh shares them.</p>
    </div>
    <div class="gallery" data-reveal>
      <div class="gallery__item gallery__item--tall gallery__item--wide" aria-hidden="true">
        <span class="gallery__label">Nariman Point office</span>
      </div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">Client review</span></div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">Team at work</span></div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">Speaking event</span></div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">AMFI recognition</span></div>
      <div class="gallery__item gallery__item--wide" aria-hidden="true"><span class="gallery__label">Family conversations</span></div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">Portfolio review</span></div>
      <div class="gallery__item" aria-hidden="true"><span class="gallery__label">Mumbai skyline</span></div>
    </div>
  </div>
</section>
